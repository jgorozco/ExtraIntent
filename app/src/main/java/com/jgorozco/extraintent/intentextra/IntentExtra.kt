...
import com.jgorozco.extraintent.*
...
class IntentExtra {
    ...
    fun <T> putSmallObjectExtra(intent:Intent,name: String, it: T, objectClass:Class<T>, serialType: SerialType): Intent {
    ...
    fun <T> getSmallObjectExtra(intent:Intent,name: String, objectClass:Class<T>, serialType: SerialType): T? {
        return when (serialType){
    ...
    private fun <T> putSimpleZipExtra(intent:Intent,name: String, it: T,objectClass:Class<T> ,serialType: SerialType):Intent {
        return when (serialType){
            SerialType.GSON_ZIP -> intent.putExtra(name,gzip(SerializeHelper.instance.toJson(it,objectClass,SerialType.GSON)))
            SerialType.JACKSON_ZIP -> intent.putExtra(name,gzip(SerializeHelper.instance.toJson(it,objectClass,SerialType.JACKSON)))
            SerialType.MOSHI_ZIP -> intent.putExtra(name,gzip(SerializeHelper.instance.toJson(it,objectClass,SerialType.MOSHI)))
            else -> intent.putExtra(name,"")
        }
    ...
    private fun <T> putSimpleExtra(intent:Intent,name: String, it: T,objectClass:Class<T> , serialType: SerialType):Intent {
        return when (serialType){
            SerialType.GSON -> intent.putExtra(name,SerializeHelper.instance.toJson(it,objectClass,SerialType.GSON))
            SerialType.JACKSON -> intent.putExtra(name,SerializeHelper.instance.toJson(it,objectClass,SerialType.JACKSON))
            SerialType.MOSHI -> intent.putExtra(name,SerializeHelper.instance.toJson(it,objectClass,SerialType.MOSHI))
            else -> intent.putExtra(name,"")
        }
    }
